...
/obj/item/device/encryptionkey/heads/marine_alpha
	name = "alpha leader's encryption key"
	icon_state = "hop_cypherkey"
	channels = list("Command" = 1, "Exploration" = 1, "Alpha Squad" = 1)

/obj/item/device/encryptionkey/heads/marine_bravo
	name = "bravo leader's encryption key"
	icon_state = "hop_cypherkey"
	channels = list("Command" = 1, "Exploration" = 1, "Bravo Squad" = 1)

/obj/item/device/encryptionkey/heads/marine_charlie
	name = "charlie leader's encryption key"
	icon_state = "hop_cypherkey"
	channels = list("Command" = 1, "Exploration" = 1, "Charlie Squad" = 1)

/obj/item/device/encryptionkey/heads/marine_delta
	name = "delta leader's encryption key"
	icon_state = "hop_cypherkey"
	channels = list("Command" = 1, "Exploration" = 1, "Delta Squad" = 1)

/obj/item/device/encryptionkey/marine_alpha
	name = "alpha squad encryption key"
	icon_state = "com_cypherkey"
	channels = list("Alpha Squad" = 1)

/obj/item/device/encryptionkey/marine_bravo
	name = "bravo squad encryption key"
	icon_state = "com_cypherkey"
	channels = list("Bravo Squad" = 1)

/obj/item/device/encryptionkey/marine_charlie
	name = "charlie squad encryption key"
	icon_state = "com_cypherkey"
	channels = list("Charlie Squad" = 1)

/obj/item/device/encryptionkey/marine_delta
	name = "delta squad encryption key"
	icon_state = "com_cypherkey"
