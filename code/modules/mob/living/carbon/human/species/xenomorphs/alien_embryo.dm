...
/obj/item/alien_embryo/Process()
	...
	switch(stage)
		if(2, 3)
			...
			if(prob(1))
				to_chat(affected_mob, "<span class='warning'>Mucous runs down the back of your throat.")
		if(4)
			if(prob(1))
				affected_mob.emote("sneeze")
			if(prob(1))
...
/obj/item/alien_embryo/proc/RefreshInfectionImage()
	...
	for(var/mob/living/carbon/human/alien in GLOB.player_list)
